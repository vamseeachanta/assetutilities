...
class VisualizationTemplates:
    ...
    def get_xy_scatter_input(self, custom_analysis_dict=None):
    ...
    def get_xy_line_input(self, custom_analysis_dict=None):
        if custom_analysis_dict is None:
            custom_analysis_dict = {}
        library_name = "assetutilities"
        library_yaml_cfg = {
    ...
    def get_xy_scatter_csv(self, custom_analysis_dict=None):
        if custom_analysis_dict is None:
            custom_analysis_dict = {}
        library_name = "assetutilities"
        library_yaml_cfg = {
    ...
    def get_xy_line_csv(self, custom_analysis_dict=None):
        if custom_analysis_dict is None:
            custom_analysis_dict = {}
        library_name = "assetutilities"
        library_yaml_cfg = {
    ...
    def get_x_datetime_input_matplotlib(self, custom_analysis_dict=None):
        if custom_analysis_dict is None:
            custom_analysis_dict = {}
        library_name = "assetutilities"
        library_yaml_cfg = {
