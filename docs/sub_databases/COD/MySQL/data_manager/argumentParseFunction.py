...
def argumentParseFunction():
    ...
    parser.add_argument(
        "--log", dest="log", nargs=1, help="You must pass the --log value"
    )

    parser.add_argument(
        "--SQLType", dest="SQLType", nargs=1, help="You must pass the --SQLType value"
    )
    ...
    parser.add_argument(
        "--MySQLServerName",
        dest="MySQLServerName",
        nargs=1,
        help="You must pass the --SQLServerName Value",
    )
    parser.add_argument(
        "--MySQLDatabaseName",
        dest="MySQLDatabaseName",
        nargs=1,
        help="You must pass the --SQLDatabaseName Value",
    )
    parser.add_argument(
