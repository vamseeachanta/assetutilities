...
e_simp = round(
    sqrt(
        f
        / e
        * ((xx / Exx_simp) ** c + (yy / Eyy_simp) ** c + (t1 / TE_simp) ** c) ** (1 / c)
    ),
    2,
)
...
print(
    "Enter the value of q ,Exx_simp,Eyy_simp and TE_simp is",
    q,
    Exx_simp,
    Eyy_simp,
    TE_simp,
...
print(
    "Enter the value of x_simp,y_simp,t_simp and e_simp is",
    x_simp,
    y_simp,
    t_simp,
    e_simp,
...
print(
    "The value of scrx_simp,scry_simp,scrz_simp and escr_simp is",
    scrx_simp,
    scry_simp,
    scrz_simp,
    escr_simp,
...
print(
    "The value of sx_simp,sy_simp,sz_simp and se_simp is",
    sx_simp,
    sy_simp,
    sz_simp,
    se_simp,
...
print(
    "The value of ux_simp,uy_simp,uz_simp and ue_simp is",
    ux_simp,
    uy_simp,
    uz_simp,
    ue_simp,
