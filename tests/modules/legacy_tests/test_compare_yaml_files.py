...
def compare_yaml_file_content_deepdiff():
    ...
    file_name1 = "tests/modules/yaml_utilities/SZ_trim_VA.yml"
    file_name2 = "tests/modules/yaml_utilities/SZ_trim_QA.yml"
    ...
    cfg = {
        ...
        "map_list": {"file_name1": ["General"], "file_name2": ["General"]},
    }
