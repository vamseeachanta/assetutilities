<<<<<<< Updated upstream:tests/modules/yml_utilities/yaml_divide/test_divide_yaml_file.py
import os
import sys
...
test_run_process()
>>>>>>> Stashed changes:tests/modules/yaml_utlities/yaml_divide/test_divide_yaml_file.py
