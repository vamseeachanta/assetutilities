<<<<<<< Updated upstream:tests/modules/yml_utilities/yml_single_variable_test.py
...
def test_run_process():
    ...
    input_file = "yml_single_variable.yml"
...
test_run_process()
>>>>>>> Stashed changes:tests/modules/yaml_utlities/yml_single_variable_test.py
