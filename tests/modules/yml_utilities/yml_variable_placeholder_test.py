<<<<<<< Updated upstream:tests/modules/yml_utilities/yml_variable_placeholder_test.py
...
test_run_process()
>>>>>>> Stashed changes:tests/modules/yaml_utlities/yml_variable_placeholder_test.py
