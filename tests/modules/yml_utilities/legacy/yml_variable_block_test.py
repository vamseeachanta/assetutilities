<<<<<<< Updated upstream:tests/modules/yml_utilities/legacy/yml_variable_block_test.py
...
test_run_process()
>>>>>>> Stashed changes:tests/modules/yaml_utlities/legacy/yml_variable_block_test.py
